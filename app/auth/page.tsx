...
export default function AuthPage() {
  ...
  // Enabled social providers (fetched from server)
  ...
  const hasAnySocialProvider =
    providersLoaded &&
    Object.values(enabledProviders).some((enabled) => enabled);
      ...
      <div className="flex-1 flex items-start justify-center pt-10 pb-16 px-4">
        <div className="w-full max-w-md flex flex-col gap-6">
          ...
          <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
            ...
            {/* Social login divider - only show if any provider is enabled */}
